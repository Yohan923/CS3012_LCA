...
class LCA:
    ...
    def lca(self, tree, a, b):
        ...
        lca = self.find_lca(tree.root, a, b, exists)
    ...
    def find_lca(self, root, a, b, exists):
        if root is None:
            return None
        ...
        left_node = self.find_lca(root.left, a, b, exists)
        right_node = self.find_lca(root.right, a, b, exists)
